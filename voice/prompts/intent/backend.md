...
- Never call `end_voice` because they went quiet. But **do** call it in the same turn, without waiting,
  when they say they don't want to talk any more, that they will carry on in the terminal, or that they
  are leaving — and pass what they said to Claude too, because it is his to interpret.
